...
## Page 1
```{r}
# What do you think Group 1 should say about whether their data agree with the 
# model?
...
# Which statements below support your reasoning for whether Group 1's data agree 
# with the model?
...
# How effective do you think Group 1's method was for testing whether the data 
# obey the model?
...
# What feature was most important to you in evaluating the effectiveness of Group 
# 1's methods (either as strengths or weaknesses)?
...
# What do you think Group 1 should do next?
...
## Page 2
```{r}
# What do you think Group 2 should say about whether their data agree with the 
# model?
...
# Which statements below support your reasoning for whether Group 2's data agree 
# with the model?
...
# How effective do you think Group 2's method was for testing whether the data 
# obey the model?
...
# What feature was most important to you in evaluating the effectiveness of Group 
# 2's methods (either as strengths or weaknesses)?
...
# What do you think Group 2 should do next?
...
# Which fit do you think Group 2 should use?
...
# Others: Either fix the intercept at zero or change the model., both, I think 
# the results of both fits should be discussed, including whether there is a 
# natural explanation for adding an intercept in a revised model

# Which items below best reflect your reasoning?
...
## Page 4
```{r}
# Which group do you think did a better job of testing the model?
...
# What feature was most important to you for comparing the two groups?
