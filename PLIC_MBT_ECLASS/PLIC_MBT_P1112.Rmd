...
# Read MBT files
```{r}
df.MBT.P1112.F2019pre <- Read.Score.MBT('C:/Users/Cole/Documents/MBT_DATA/Physics_1112_Pre_Test_Fall_2019.csv', 
                                        skip.vec = c(1, 2)) %>%
...
df.MBT.P1112.F2019post <- Read.Score.MBT('C:/Users/Cole/Documents/MBT_DATA/Physics_1112_Post_Test_Fall_2019.csv', 
                                     skip.vec = c(1, 2)) %>%
  filter((Finished == 1) & (Q82 == 1)) %>% # only keep students that finished and consented
  select(QA, QB, QC, QD, score) %>%
  `colnames<-`(c('last.name', 'first.name', 'net.id', 'student.id', 'MBT.score'))

df.MBT.P1112.S2019pre <- Read.Score.MBT('C:/Users/Cole/Documents/MBT_DATA/Physics_1112_Pre_Test_Spring_2019.csv')
...
df.MBT.P1112.S2019post <- Read.Score.MBT('C:/Users/Cole/Documents/MBT_DATA/Physics_1112_Post_Test_Spring_2019.csv')
